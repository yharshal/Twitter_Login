...
//        goToLoginPage()
    ...
    fileprivate func goToLoginPage() {
        ...
        if let _ = UserDefaults.standard.value(forKey: "userid") as? String, let name = UserDefaults.standard.value(forKey: "userName") as? String {
            ...
            profileVC.navigationItem.title = name
            let navigationController = UINavigationController(rootViewController: profileVC)
            window?.rootViewController = navigationController
        } else {
            let loinVC = mainStoryBoard.instantiateViewController(withIdentifier: "LoginViewController") as! LoginViewController
            window?.rootViewController = loinVC
        }
    }
